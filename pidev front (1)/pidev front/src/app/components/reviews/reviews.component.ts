...
@Component({
      ...
      <div class="reviews-body">
        ...
        <section class="write-review-card">
          ...
          <div class="form-group">
            ...
            <span class="error-msg" *ngIf="touched['rating'] && !form.rating">
          ...
          <div class="form-group">
            ...
            <span class="error-msg" *ngIf="touched['reviewReason'] && !form.reviewReason">
              ⚠ Please select a reason for your review.
            </span>
          </div>
  ...
  styles: [`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* NEW: red border when field has error */
    .input-error {
      border-color: #ef4444 !important;
    }

    /* NEW: red warning text under fields */
    .error-msg {
      display: block;
      color: #ef4444;
      font-size: 0.82rem;
    ...
    /* NEW: reason badge below the review header */
    .reason-badge {
      display: inline-flex;
      align-items: center;
      gap: 0.4rem;
...
export class ReviewsComponent implements OnInit {
  ...
  // Tracks which fields have been interacted with (for real-time validation)
  ...
  // Mark a field as touched so validation shows
  touch(field: string) {
    this.touched[field] = true;
  }

  // Mark all fields touched so errors appear on submit attempt
  touchAll() {
    ['author', 'rating', 'reviewReason', 'content'].forEach(f => this.touched[f] = true);
  }

  isFormValid(): boolean {
    return !!(this.form.author && this.form.content && this.form.rating && this.form.reviewReason);
  }
