...
import {
  ...
  transition,
  trigger
} from "./chunk-V4RQCGJJ.js";
import {
  NG_VALIDATORS,
  NG_VALUE_ACCESSOR
} from "./chunk-X4OSQBHQ.js";
import {
  AsyncPipe,
  NgTemplateOutlet
} from "./chunk-R2B7T4EU.js";
import {
  DOCUMENT
} from "./chunk-OPMNEA3F.js";
import {
...
function FileUploadComponent_Conditional_7_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngTemplateOutlet", ctx_r3.listItem() ? ctx_r3.listItem() : defaultItemTemplate_r7)("ngTemplateOutletContext", ctx_r3.getListItemTemplateContext(ɵ$index_33_r6, file_r5));
  }
}
...
function FileUploadComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵrepeaterCreate(1, FileUploadComponent_Conditional_7_For_2_Template, 1, 2, "ng-container", null, ɵɵcomponentInstance().trackByFn, true);
    ɵɵpipe(3, "async");
    ɵɵelementEnd();
  ...
  if (rf & 2) {
    const ctx_r3 = ɵɵnextContext();
    ɵɵproperty("@insertAnimation", ctx_r3.getControlInstance().size);
    ɵɵadvance();
    ɵɵrepeater(ɵɵpipeBind1(3, 1, ctx_r3.getControlInstance().valueChanges));
  }
}
var _c5 = ["overlay"];
var _c6 = ["file-drop-zone", ""];
...
function SimpleFileUploadComponent_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngTemplateOutlet", ctx_r1.placeholderRef() ? ctx_r1.placeholderRef() : defaultPlaceholderTemplate_r3)("ngTemplateOutletContext", ɵɵpureFunction3(2, _c10, ctx_r1.getControlInstance().value, ctx_r1.getControlInstance(), ctx_r1.getControlInstance().value));
  }
}
...
function SimpleFileUploadComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵrepeaterCreate(0, SimpleFileUploadComponent_ng_template_3_For_1_Template, 3, 2, null, null, ɵɵcomponentInstance().trackByFn, true, SimpleFileUploadComponent_ng_template_3_ForEmpty_2_Template, 1, 0);
  }
  if (rf & 2) {
...
var FileUploadAbstract = class _FileUploadAbstract {
  constructor() {
    this.control = input(new FileUploadControl());
    this.input = viewChild.required("inputRef", {
      read: ElementRef
    });
    this.label = viewChild.required("labelRef", {
      read: ElementRef
    });
    this.isMultiple = input(null, {
  ...
  registerEvents() {
    ...
    this.subscriptions.push(control.statusChanges.subscribe((status) => this.checkAndMarkAsDisabled()));
    this.subscriptions.push(control.eventsChanges.subscribe((event) => this.triggerEvent(event)));
    this.subscriptions.push(control.acceptChanges.subscribe((accept) => this.updateAcceptAttr(accept)));
    this.subscriptions.push(control.multipleChanges.subscribe((isMultiple) => this.toggleMultiple(isMultiple)));
    this.subscriptions.push(merge(control.listVisibilityChanges, control.valueChanges).subscribe(() => this.checkAndSetFilesClass()));
    this.subscriptions.push(merge(control.statusChanges, control.valueChanges).subscribe(() => this.checkAndSetInvalidClass()));
  }
  clearInputEl() {
  ...
  connectToForm() {
    const control = this.getControlInstance();
    this.subscriptions.push(control.valueChanges.subscribe((v) => this.onChange(v)));
  }
  static {
  ...
  static {
    this.ɵdir = ɵɵdefineDirective({
      ...
      viewQuery: function FileUploadAbstract_Query(rf, ctx) {
        if (rf & 1) {
          ɵɵviewQuerySignal(ctx.input, _c0, 5, ElementRef);
          ɵɵviewQuerySignal(ctx.label, _c1, 5, ElementRef);
        }
        if (rf & 2) {
          ɵɵqueryAdvance(2);
        }
      ...
      inputs: {
        control: [1, "control"],
        isMultiple: [1, "multiple", "isMultiple"]
      }
    });
  }
};
...
var FileUploadComponent = class _FileUploadComponent extends FileUploadAbstract {
  constructor(fileUploadService, document) {
    ...
    this.animation = input(true, {
      transform: booleanAttribute
    });
    this.templateRef = contentChild("placeholder", {
      read: TemplateRef
    });
    this.listItem = contentChild("item", {
      read: TemplateRef
    });
  ...
  getListItemTemplateContext(index, item) {
    return {
      $implicit: item,
      file: item,
      index,
  ...
  registerEvents() {
    ...
    const control = this.getControlInstance();
    this.subscriptions.push(control.valueChanges.subscribe((files) => this.renderView()));
    this.subscriptions.push(control.listVisibilityChanges.subscribe((status) => this.toggleListVisibility()));
  }
  onKeyDown(event) {
  ...
  onInputChange(event) {
    ...
    const control = this.getControlInstance();
    if (!control.disabled && input2.files.length > 0) {
      control.addFiles(input2.files);
      this.clearInputEl();
    }
    this.onTouch();
  }
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      contentQueries: function FileUploadComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
          ɵɵcontentQuerySignal(dirIndex, ctx.templateRef, _c3, 5, TemplateRef);
          ɵɵcontentQuerySignal(dirIndex, ctx.listItem, _c4, 5, TemplateRef);
        }
        if (rf & 2) {
          ɵɵqueryAdvance(2);
        }
      ...
      template: function FileUploadComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          ɵɵadvance(5);
          ɵɵconditional(ɵɵpipeBind1(8, 4, ctx.getControlInstance().listVisibilityChanges) && ctx.getControlInstance().size > 0 && ctx.listVisible ? 7 : -1);
        }
      },
...
var FileUploadAttributeComponent = class _FileUploadAttributeComponent {
  constructor(fileUploadService, hostElementRef, renderer, document) {
    ...
    this.document = document;
    this.control = input(new FileUploadControl());
    this.overlay = viewChild("overlay");
    this.templateRef = contentChild("placeholder", {
      read: TemplateRef
    });
    this.hooks = [];
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      viewQuery: function FileUploadAttributeComponent_Query(rf, ctx) {
        if (rf & 1) {
          ɵɵviewQuerySignal(ctx.overlay, _c5, 5);
        }
        if (rf & 2) {
          ɵɵqueryAdvance();
        }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FileUploadAttributeComponent, [{
    ...
    `,
      providers: [FileUploadService],
      standalone: true,
      imports: [NgTemplateOutlet, FileUploadDropZoneComponent],
...
var SimpleFileUploadComponent = class _SimpleFileUploadComponent extends FileUploadAbstract {
  constructor(fileUploadService) {
    super();
    this.fileUploadService = fileUploadService;
    this.buttonRef = contentChild("button", {
      read: TemplateRef
    });
    this.placeholderRef = contentChild("placeholder", {
      read: TemplateRef
    });
  }
  onInputChange(event) {
    ...
    const control = this.control();
    if (!control.disabled && input2.files.length > 0) {
      control.setValue(Array.from(input2.files));
      this.clearInputEl();
    }
    this.onTouch();
  }
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      contentQueries: function SimpleFileUploadComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
          ɵɵcontentQuerySignal(dirIndex, ctx.buttonRef, _c7, 5, TemplateRef);
          ɵɵcontentQuerySignal(dirIndex, ctx.placeholderRef, _c3, 5, TemplateRef);
        }
        if (rf & 2) {
          ɵɵqueryAdvance(2);
        }
      ...
      template: function SimpleFileUploadComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          ɵɵadvance();
          ɵɵconditional(ɵɵpipeBind1(2, 3, ctx.getControlInstance().valueChanges) ? 1 : -1);
          ɵɵadvance(6);
          ɵɵproperty("ngTemplateOutlet", ctx.buttonRef() ? ctx.buttonRef() : defaultButtonTemplate_r7)("ngTemplateOutletContext", ɵɵpureFunction1(5, _c9, ctx.getControlInstance()));
        }
      },
