...
export interface ProjectProposal {
  ...
  isInvited?: boolean;
  revisionsOffered?: number;
  // Champs de contre-offre (correspondant à l'entité Java)
...
export interface FreelancerStatsDTO {
  ...
  avgResponseTimeHours: number; // createdAt → expiresAt
}

// =========================
// NEW: Ranked Proposal DTO
// =========================

export interface RankedProposalDTO {
  proposal: ProjectProposal;
  score: number;
  scoreBreakdown: string; // ex: "Price:40 | Delivery:35 | Revisions:25"
}

// =========================
// NEW: Counter Offer Request
// =========================
