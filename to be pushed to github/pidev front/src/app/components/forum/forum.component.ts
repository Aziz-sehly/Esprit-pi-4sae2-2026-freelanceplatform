...
import { ForumMessagingDialogComponent } from './forum.messaging-dialog.component';

@Component({
  selector: 'app-forum',
  standalone: true,
  imports: [CommonModule, FormsModule, ForumChatbotComponent, ForumMessagingDialogComponent],
  template: `
