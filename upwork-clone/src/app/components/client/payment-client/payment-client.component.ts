...
export class PaymentClientComponent {
  ...
  // coming from milestone row
  @Input() contractId!: number;
  @Input() milestoneId!: number;
  @Input() amount!: number;

  // you will set these from auth later; for now we keep fields editable or pass them too
  @Input() payerId: number | null = null; // client userId
  @Input() payeeId: number | null = null; // freelancer userId

  @Output() closed = new EventEmitter<void>();
  @Output() paid = new EventEmitter<PaymentResponse>(); // notify parent to refresh
