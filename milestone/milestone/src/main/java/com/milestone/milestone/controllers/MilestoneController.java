...
public class MilestoneController {
    ...
    public MilestoneResponse requestRevision(@PathVariable Long id, @RequestBody @Valid MilestoneFeedbackRequest req) {
        return service.requestRevision(id, req);
    }
