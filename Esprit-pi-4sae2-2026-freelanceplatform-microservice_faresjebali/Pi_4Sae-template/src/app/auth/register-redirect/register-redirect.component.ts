...
@Component({
    ...
    <div class="auth-wrap">
      <div class="auth-card">
        ...
        <form (ngSubmit)="submit()" class="auth-form">
          ...
          <input [(ngModel)]="password" name="password" type="password" placeholder="Mot de passe (min. 8 caractères)" required />
  ...
  styles: [`
    ...
    .success { color: #059669; margin: 0; font-size: 0.9rem; }
  ...
  submit(): void {
    ...
    this.authService.register({
      ...
      next: (r) => {
        ...
        setTimeout(() => this.router.navigateByUrl('/front/login'), 2500);
      },
      error: (err) => {
        this.loading = false;
