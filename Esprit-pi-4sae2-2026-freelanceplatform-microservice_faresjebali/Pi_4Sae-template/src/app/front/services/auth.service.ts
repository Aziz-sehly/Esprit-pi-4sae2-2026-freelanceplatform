...
/** Profil public {@code GET /users/public/{id}} (sans token requis côté gateway). */
...
export class AuthService {
  ...
  getPublicUser(id: number): Observable<PublicUserProfile> {
    return this.http.get<PublicUserProfile>(`${this.baseUrl}/public/${id}`);
  }
